...
app_dir="$output_dir/WacomInputTest.app"
...
cp "$project_root/index.html" "$resources_dir/index.html"
cp "$project_root/app.js" "$resources_dir/app.js"
cp "$project_root/styles.css" "$resources_dir/styles.css"
...
xcrun clang++ \
  ...
  -o "$executable_dir/WacomInputTest"
